...
INSERT INTO books (
  id, title, author, description, genre, cover_path,  pages_amount
)
VALUES
   (
    1, 'Trzy królowe', 'Geneva Lee',
    '<p>Cała magia umrze, a wraz z nią wszyscy, którzy nią władają.</p>
<p>Trzeci tom porywającej historii miłosnej rozgrywającej się w luksusowym świecie bogatych wampirów.</p>
<p>Thea i Julian muszą stawić czoła konsekwencjom swojego wyboru. Podczas balu z okazji zimowego przesilenia planują ogłosić status swojego związku przed społecznością wampirów. Jednak niespodziewane wypadki zmienią bieg wydarzeń tej nocy.</p>
<p>Matka Thei znika, a wszystkie wskazówki prowadzą do Wenecji. Kiedy Thea zostaje porwana, Julian będzie musiał zmierzyć się z niebezpieczeństwami i swoją przeszłością. Stawić czoło potworowi, którym kiedyś był. Wkrótce ich miłość i cały magiczny świat staną na krawędzi wojny. Czy uda im się uniknąć konfliktu i przetrwać, czy może będą musieli zapłacić najwyższą cenę?</p>',
    'Romans', '/images/1.jpeg', 464
   ),
   (
    2, 'Klątwa prawdziwej miłości', 'Stephanie Garber',
    '<p>Ostatni tom bestsellerowej trylogii autorki „Caravala”</p>
<p>Jak zakończy się historia miłosnego trójkąta? Czy Evangelina kiedykolwiek będzie naprawdę szczęśliwa? Z kim przyjdzie dzielić jej życie?</p>
<p>Wydaje się, że Evangelina Fox znalazła na Cudownej Północy upragnione szczęście. Wyszła za pięknego i kochającego księcia, mieszka w bajecznym zamku i ma zastępy wiernych poddanych. Nie wie jednak, jak ogromną cenę zapłaciła za życie w tej baśni, bo… niczego nie pamięta. Jej mąż zrobi wszystko, żeby nigdy nie dowiedziała się, co naprawdę straciła. Najpierw jednak musi zabić Jacksa, Księcia Serc…</p>
<p>Poleje się krew, będą złamane serca, a prawdziwa miłość zostanie wystawiona na próbę.</p>
<p>Dwa czarne charaktery, jedna dziewczyna i walka na śmierć i życie o szczęśliwe zakończenie.</p>',
    'Fantastyka', '/images/2.jpeg', 320
   ),
   (
    3, 'Stars Among Us', 'Agnieszka Karecka',
    '<p>Siedemnastoletnia Hayley Anderson obrała sobie w życiu jeden cel – za wszelka cenę zostać lekarką. Jej idealny plan na przyszłość nagle staje pod znakiem zapytania. Babcia trafia do szpitala, a nieletnią Hayley ma się zająć znienawidzona przez nią ciotka Gianna. Co więcej, czeka ją przeprowadzka do Nowego Jorku i zmiana szkoły. Hayley trafia do elitarnej placówki z internatem, szkoły dla artystów, o której marzy większość nastolatków, ale nie ona – muzyka nie zajmuje najmniejszego miejsca w jej życiu, tak przynajmniej twierdzi. Próbuje połączyć naukę do egzaminów końcowych z obowiązkowymi zajęciami muzycznymi, lecz staje się to coraz trudniejsze. Na jej drodze pojawiają się kolejne przeszkody: wredna współlokatorka uprzykrzająca jej życie, zabójczo przystojny partner na zajęciach tanecznych, a wreszcie nagana dyrektora za marne postępy muzyczne. Hayley musi wziąć się w garść, jeśli nie chce zostać wydalona ze szkoły i trafić do rodziny zastępczej… [na skrzydełko] AGNIESZKA KARECKA z wykształcenia jest nauczycielką, jej prawdziwą pasją stała się jednak praca z książkami i wśród książek. Na co dzień świetnie odnajduje się w roli bibliotekarki. Miłośniczka literatury obyczajowej, romansów i powieści fantasy. Uwielbia inspirować się życiem i pisać o nim, a także zastanawiać się „co by było, gdyby…”. Prywatnie żona i mama, nieco introwertyczna, zwykle uśmiechnięta.</p>',
    'Dla dzieci', '/images/3.jpeg', 336
   ),
   (
    4, 'Motyl i Śmierć', 'Agata Konefał',
    '<p>Trzy monarchie spętane przez wojnę.</p>
<p>Królestwo Elfów, Grandwalia, zawiera sojusz z Cesarstwem Magów, Krystalią, żeby przerwać ciąg krwawych bitew z Królestwem Landong. Robią wszystko, by przechytrzyć wroga, jednak ten zawsze zdaje się być o krok przed nimi.</p>
<p>Estera musi stanąć oko w oko z niebezpieczeństwem i zaryzykować własnym życiem, jeśli ma ocalić cesarza. Odkrycie tożsamości szpiegów nie jest łatwe, a ona musi uważać, żeby podczas ich demaskowania nie wyjawić sekretu swojego rodu.</p>
<p>Ivan wraca na front, gotów zwyciężyć za wszelką cenę. Każdego dnia ociera się o śmierć, dostrzega cierpienie niewinnych ludzi, przez co zanika jego poczucie wartości życia. W chwili, w której czuje, że wszystko wreszcie idzie w dobrym kierunku, otrzymuje bardzo złe wieści ze stolicy.</p>
<p>Oboje toczą własne bitwy, mierząc się ze swoim przeznaczeniem. Czy mają w sobie dość determinacji, by nie ugiąć się pod ich ciężarem?</p>
<p>W chwili, w której losy ich bliskich są niepewne, oni dwoje stają przed decydującymi wyborami. By zakończyć tę wojnę, postawią na szali własną, wymarzoną przyszłość.</p>',
    'Fantastyka', '/images/4.jpeg', 634
   ),
   (
    5, 'Fałszywe intencje', 'Mike Omer',
    '<p>Autor bestsellerów „New York Timesa” i „The Washington Post” Mike Omer nadchodzi z nową serią pełną psychologicznych zwrotów akcji oraz zaskakujących posunięć policji, które jego wierni fani znają z poprzednich serii i kochają.</p>
<p>Abby Mullen w dzieciństwie przebywała w sekcie Wilcox, ale uciekła, gdy siedziba sekty spłonęła. Lata później jest najlepszym negocjatorem policji nowojorskiej, wychowuje córkę i uważa, że najgorszą część życia ma już za sobą. Wtedy dochodzi do ataku na miejscową szkołę, do której uczęszcza córka Abby. Grupa uzbrojonych zwolenników teorii spiskowych, nazywających siebie Watchers, bierze dziewczynę na zakładniczkę.</p>
<p>Nieuchwytni Watchers przetrzymują Samanthę. Abby musi opanować emocje, mimo że jest u granic wytrzymałości. Czas ucieka, a ona nie ma wyjścia – musi negocjować z grupą szaleńców i odkryć sekret ich przywódcy, zanim będzie za późno. Choć wydaje jej się, że jest blisko rozwiązania, wciąż odkrywa kolejne tajemnice. Co gorsza, porywacze mają powiązania z sektą, o której Abby próbowała zapomnieć.</p>
<p>Mike Omer powraca w świetnej formie i znów oferuje doskonałą, mrożącą krew w żyłach rozrywkę.</p>',
    'Kryminał', '/images/5.jpeg', 494
   ),
   (
    6, 'Kraina Czarów', 'Shannon Hale',
    '<p>Od uczniów baśnioceum Ever After High oczekuje się, że bez dyskusji podpiszą Księgę Baśni, przyrzekając tym samym posłuszeństwo przeznaczeniu, które dostają w spadku od baśniowych rodziców. Gdy na scenę wkracza Raven Queen, oczekiwania te przestają być oczywiste. Nikt już nie ma pewności, co go czeka - nawet najszlachetniejsza ze wszystkich szlachetnie urodzonych dam, Apple White.</p>
<p>Sprawy poważnie komplikuje tajemniczy stwór z Krainy Czarów, który zaraża Ever After High szaloną magią. Baśniowa kraina pogrąża się w chaosie. Lizzie Hearts, przyszła królowa Krainy Czarów, Cedar Wood, drewniana córka Pinokia, i Madeline Hatter, dziedziczka Zaczarowanej Herbaciarni Szalonego Kapelusznika, jako jedyne nie tracą głowy. Zagrożona jest szkoła i jej uczniowie - to od dziewczyn zależy, czy uda się uchronić Krainę Baśni przed bardzo nieszczęśliwym zakończeniem.</p>
<p>Trzecia książka o dzieciach bajkowych postaci, które uczęszczają do baśnioceum Ever After High</p>
<p>Książki Ever After High są ściśle powiązane ze światem zabawek firmy Mattel, który z powodzeniem zadebiutował w Polsce</p>
<p>Ciesząca oko, wysmakowana oprawa graficzna, dobry poziom literacki i współczesne, pomysłowe podejście do klasycznych baśniowych motywów tworzą z tej serii nową klasykę dla czytelniczek w wieku 8-12 lat</p>',
    'Fantastyka', '/images/6.jpeg', 312
   ),
   (
    7, 'Małpi szał', 'Carlton Mellick III',
    '<p>Niczym Piątek, trzynastego w reżyserii Takashiego Miike. Małpi szał to miłosny liścik Carltona Mellicka III do najlepszych (i zarazem najgorszych) horrorów klasy B. Szóstka popularnych nastolatków – trzy cheerleaderki oraz trzech członków szkolnej drużyny futbolowej – wyjeżdża do samotnej chatki w górach na weekend, nastawiając się na alkohol, imprezy i szalony seks. Zamiast tego czeka ich walka na śmierć i życie z przeraźliwie zmutowanym, psychotycznym dziwolągiem, który za nic nie chce umrzeć. Mellick parodiuje horrorowe motywy i przekształca je w twór znacznie głębszy i dziwniejszy. To literacki ekwiwalent niskobudżetowego kina. To mokry sen fana splatterpunku. To prawdopodobnie jedna z najbardziej posranych książek, jakie kiedykolwiek napisano. Gratka dla wszystkich lubujących się w serii Martwe zło, wczesnej twórczości Petera Jacksona oraz horrorach o mutantach. Przeczytajcie, warto!</p>',
    'Horror', '/images/7.jpeg', 160
   ),
   (
    8, 'Genesis', 'Maxime Chattam',
    '<p>Ścigani przez imperatora i przez Entropię, Matt, Tobias, Amber i ich przyjaciele muszą uciekać na nieznane ziemie, by zdobyć ostatnie Jądro Ziemi, zanim zostanie zniszczone. Ale podziemny świat, do którego trafiają, kryje nie tylko zagrożenia. Ma wiele niesamowitych tajemnic. Zbliża się wojna. I nie da się uniknąć ofiar. Trwa ostatni wyścig. Inny Świat wreszcie ujawnia wszystkie swoje sekrety.</p>',
    'Fantastyka', '/images/8.jpeg', 566
   ),
   (
    9, 'Dawno temu w Warszawie', 'Jakub Żulczyk',
    '<p>Stało się.</p>
<p>Świat się skończył.</p>
<p>Nadeszło Groźne i Inne.</p>
<p>Przestańcie się mazać, to dopiero początek.</p>
<p>Nie zapinajcie pasów. To bez sensu.</p>
<p>2014. Jacek Nitecki stoi samotny przed halą odlotów Okęcia. Zaczyna padać deszcz. Dzwoni telefon. Jacek odbiera, myśląc, że jego droga do piekła właśnie się skończyła. Ale ona dopiero się zaczyna.</p>
<p>2020. Warszawa wchodzi w kolejną falę pandemii.</p>
<p>Lockdown zamyka ludzi w ich domach, w ich głowach, w kleszczach lęku. W środku tego szaleństwa Marta Pazińska próbuje walczyć o życie i godność tych, którzy są samotni i bezbronni. Nie rozumie jednak, że cała Warszawa stała się bezbronna jak dziecko. A ci, którzy przez lata czaili się w ciemności, teraz ruszyli po władzę. Idą po nią po trupach dzieciaków, policjantów, polityków. Kości chrzęszczą pod ich stopami.</p>
<p>Parę lat po wydarzeniach ze Ślepnąc od świateł bohaterowie tamtej powieści schodzą pod powierzchnię miasta, zanurzają się w płynącym pod nim złu. A zło jest zimne. I gęste.</p>',
    'Literatura obyczajowa', '/images/9.jpeg', 800
   ),
   (
    10, 'Przedpiekle', 'Katarzyna Żwirełło',
    '<p>Kiedy w brutalny sposób zostaje zamordowana prostytutka, a zamieszeni w sprawę są poseł i policjant, przed Alanem Bergiem stoi prawdopodobnie najtrudniejsza sprawa w karierze. Wplątany w sieć śmiertelnie niebezpiecznych tajemnic, bardzo szybko z łowcy stanie się ofiarą. Bo kiedy na ścieżce sprawiedliwości krzyżują się policja, polityka i mafia, trudno liczyć na szczęśliwe zakończenie. Przedpiekle to mocna i bezkompromisowa proza, a jej konstrukcja i labirynt możliwych rozwiązań nie pozwalają na chwile wytchnienia aż do piorunującego finiszu.</p>',
    'Horror', '/images/10.jpeg', 464
   ),
   (
    11, 'Ogrody ciszy', 'Marek Adam Grabowski',
    '<p>W makabrycznej wizji przyszłości część ludzkości jest eksterminowana, rzekomo dla jej własnego dobra. Orfeusz, psycholog w obozie koncentracyjnym, zajmuje się przekonywaniem ludzi, iż lepiej jest dla nich, że zostaną uśmierconymi. W pewnym momencie zaczyna sobie zdawać sprawę, że bierze udział w wielkim oszustwie.</p>
<p>Marek Adam Grabowski urodzony 3 lutego 1987 roku w Warszawie. Absolwent (w ramach UW) Filozofii (studia pierwszego i drugiego stopnia), resocjalizacji (studia drugiego stopnia), polityki wydawniczej i księgarskiej (studia podyplomowe) i pedagogiki (studia podyplomowe). Pracuje w firmie rodzinnej. Opowiadania publikował w „Lampie” , „Przeglądzie Literacko-Filozoficznym”, „Helikopterze”, na swoim blogu „zapisacmarzenia.pl” i wielu portalach literackich. Jego dwa opowiadania „Pomniki w Śródmieściu” i „Życie na prowincji jest spokoje” ukazały się w czwartej antologii Stajni Literackiej SPP „Do czytania” pod redakcją profesora Piotra Müldnera-Nieckowskiego.</p>',
    'Fantastyka', '/images/11.jpeg', 100
   ),
   (
    12, 'Santa Clown', 'Julius Throne',
    '<p>Przygotuj się na najbardziej ekscytujące święta swojego życia!
<p>USA, Rockville, rok 1985 rok.
<p>Miasto tonie w śniegu, słychać wesołe dźwięki dzwonków i kolędy śpiewane przez mieszkańców, ale tuż obok czai się coś mrocznego…</p>
<p>W środku świątecznego szaleństwa w sklepach pojawiają się tajemnicze zabawki dragondoll i dragoncar. Tylko niewielka grupa dzieciaków domyśla się, że te pozornie niewinne przedmioty stanowią element koszmaru zagrażającego świętom Bożego Narodzenia. Młodzi przyjaciele podejmują się obrony miasta i świąt. Wraz z nimi do walki z przestępcami stają emerytowany policjant oraz policjantka, która tropi w Waszyngtonie siejącą postrach, demoniczną postać Santa Clowna.</p>
<p>Czy bohaterowie będą w stanie zapobiec nieszczęściu i przywrócić spokój świątecznej atmosferze? Czy Boże Narodzenie przetrwa?</p>
<p>Kiedy Julius Throne łączy święta z horrorem, powstaje niezapomniana opowieść o odwadze, nadziei i walce.</p>',
    'Fantastyka', '/images/12.jpeg', 463
   ),
   (
    13, 'Gen 56', 'Adrianna Biełowiec',
    '<p>Zaleca się zachować ostrożność przy podchodzeniu do latających stułbi – mogą tryskać kwasem!</p>
<p>Trwa czwarta wojna światowa. Szeregowy Aksel Sikora po incydencie w jednostce widzi tylko dwa wyjścia. Oba są złe. Ale mając wybór między schylaniem się w więzieniu po mydło a napromieniowaniem przez czerwonego karła, wybierze oczywiście tę ciekawszą opcję. Rzeczywistość jednak go przerośnie. Będzie musiał odnaleźć się w całkowicie nowej sytuacji i zmierzyć z najgorszymi koszmarami, przy których te senne to istne eldorado.</p>
<p>Historia będąca pierwotnie opowiadaniem z antologii, pełna nawiązań do popkultury oraz wydarzeń historycznych. Idealna dla osób zaczynających przygodę z science fiction albo szukających relaksującej lektury.</p>',
    'Science-fiction', '/images/13.jpeg', 140
   ),
   (
       14, '40.Raków', 'Agnieszka Peszek',
       '<p>Traumy z dzieciństwa czasami wdzierają się tak głęboko w umysł, że nawet po latach jedynym sposobem, aby się ich pozbyć, jest ukaranie oprawcy.</p>
<p>Warszawą wstrząsa seria okrutnych zbrodni. Ktoś z niewiadomych powodów odcina kobietom części ciała: głowę, ucho, nogę…</p>
<p>Na czele śledztwa staje komisarz Maksymilian Obrębski, a wspiera go dwóch średnio ogarniętych policjantów z patrolu, którzy uzupełniają braki kadrowe. Czy uda im się dowiedzieć, kto za tym stoi? Czy będą w stanie uratować kolejne kobiety przed mordercą nazwanym przez prasę „Brzytwą”?</p>
<p>„40. Raków” to wciągająca powieść z pogranicza kryminału i thrillera psychologicznego, w której spotkasz aż dwóch morderców. Kto wie, być może jedną z tych osób nawet polubisz…</p>',
       'Horror', '/images/14.jpeg', 418
   ),
   (
       15, 'Przewoźniczka dusz', 'Malwina A. Tylewicz',
       '<p>We współczesnym Poznaniu dzieją się tajemnicze rzeczy. Zdegradowany anioł stróż dostaje nowe zadanie, ma pilnować snów pewnej dziewczyny, aby zapobiec jasnowidzeniu. Szybko okazuje się, że należy ona do magicznych, odwiecznych wrogów wysłanników Nieba. Aaron staje przed dylematem czy wydać swoją podopieczną przełożonym, czy pomóc jej w śledztwie dotyczącym zaginionego Jakuba Grabskiego.</p>
<p>Czy Berenice i Aaronowi uda się na czas odnaleźć uprowadzonego chłopaka i jaki jeszcze sekret skrywa podopieczna anioła?</p>',
       'Fantastyka', '/images/15.jpeg', 331
   ),
   (
       16, 'Grudniowy dom', 'Magdalena Knedler',
       '<p>Tajemnica, miłość i szansa na nowy start.</p>
<p>Wyjątkowa powieść na zimowy wieczór!</p>
<p>Początek grudnia. Kami przekracza próg poniemieckiego domu, który właśnie odziedziczyła po babce. Powracają wspomnienia, a w głuchej ciszy coraz wyraźniej dają o sobie znać tajemnice, wśród których dorastała. Jaki sekret ukrywała jej babcia? Co stało się z dziadkiem, który zniknął wiele lat wcześniej?</p>
<p>Pobyt w starym domu może być dla Kami okazją do uporania się z przeszłością, ale też… początkiem nowego życia. Czy właśnie to zwiastuje Jasiek, dawny znajomy, który zjawia się przed drzwiami ze świątecznym drzewkiem?</p>
<p>Poznaj tajemnice grudniowego domu. Sięgnij po wyjątkową historię o poszukiwaniu siebie. Przeczytaj wciągającą powieść Magdy Knedler, pisarki nominowanej do Bestsellera Empiku.</p>',
       'Literatura obyczajowa', '/images/16.jpeg', 320
   ),
   (
       17, 'Dwadzieścioro czworo oczu', 'Sakae Tsuboi',
       '<p>Japonia, rok 1928. Pracę w wiejskiej szkółce rozpoczyna młoda nauczycielka, Hisako Ōishi. Choć spotyka się z chłodnym przyjęciem lokalnej społeczności, dzieci szybko zaczynają darzyć ją sympatią. Nawet gdy odchodzi z posady, nie traci kontaktu ze swoimi uczniami.</p>
<p>Lata mijają, jej podopieczni dorastają, a sytuacja społeczna w Japonii znacząco się zmienia. Jak potoczyły się losy dwanaściorga dzieci, które wiosną 1928 roku rozpoczęły naukę pod skrzydłami panny Ōishi?</p>
<p>Dwadzieścioro czworo oczu to opowieść o japońskiej wsi, dorastaniu w nękanym klasowymi nierównościami kraju i wchodzeniu w dorosłość w trakcie drugiej wojny światowej</p>',
       'Historia', '/images/17.jpeg', 201
   ),
    (
         18, 'Kraina Chichów', 'Jonathan Carroll',
         '<p>Książka Kraina Chichów to książka, od której czytelnikowi włos się jeży na głowie, gdyż okazuje się, że potworem może być wszystko, co nas otacza: znajomi, jedzenie na stole i półki pełne książek. Jest to też powieść o cudzie i grozie tworzenia - porusza problem osiągnięcia artystycznego: czy wielki pisarz jest zarazem wielkim alchemikiem, zdolnym przemienić słowo zapisane na papierze w człowieka w niebieskim kapeluszu, który naprawdę stanie pod naszymi drzwiami? A jeżeli jest do tego zdolny, to czy jest to wspaniałe, czy potworne?</p>',
         'Fantastyka', '/images/18.jpeg', 237
    ),
    (
         19, 'Wierzyliśmy jak nikt', 'Rebecca Makkai',
         '<p>Epicka powieść o przyjaźni i odkupieniu w obliczu tragedii, finalistka nagrody Pulitzera oraz National Book Award, a przy tym jedna z najważniejszych książek ostatnich lat wg "New York Timesa", "The Washington Post" i "Entertainment Weekly".</p>
<p>W 1985 roku młody Yale Tishman, dyrektor rozwoju chicagowskiej galerii sztuki, zamierza namieszać w środowisku amerykańskiej bohemy, wprowadzając na wystawę zbiór nadzwyczaj udanych obrazów z lat 20. Jego kariera zdaje się kwitnąć, ale wokół AIDS zbiera okrutne żniwo – przyjaciele Yale’a jeden po drugim umierają i wkrótce zostaje on niemal zupełnie sam.</p>
<p>Trzydzieści lat później Fiona, przyjaciółka Yale''a, próbuje odnaleźć w Paryżu swoją zaginioną córkę. Zatrzymuje się na pewien czas u starego przyjaciela, znanego fotografa, który przed laty uwiecznił chicagowską epidemię. Z czasem kobieta zdaje sobie sprawę, w jak wielkim stopniu wydarzenia sprzed lat mogą ukształtować nas samych i nasze relacje z najbliższymi.</p>
<p>Losy Yalea i Fiony przeplatają się na przestrzeni lat, zabierając tym samym czytelników w rozdzierającą podróż przez lata osiemdziesiąte aż po chaos czasów współczesnych.</p>
<p>"Porywająca opowieść... Nie oderwiecie się od tej książki".</p>
<p>Michael Cunningham</p>',
         'Literatura piękna', '/images/19.jpeg', 624
    ),
    (
         20, 'Schronisko, które przestało istnieć', 'Sławek Gortych',
         '<p>Młody stomatolog Maksymilian Rajczakowski jedzie w Karkonosze, by odetchnąć od rodzinnych problemów. Nie jest świadomy tajemnic drzemiących w wojennej przeszłości gór. Czy znajdzie to, czego szuka?</p>
<p>Właściciel nieczynnego schroniska Nad Śnieżnymi Kotłami ginie w nieszczęśliwym wypadku. Niedługo po tej tragedii na miejsce przybywa jego bratanek Maksymilian. Mężczyzna dowiaduje się, że przed śmiercią wuj z niejasnych przyczyn interesował się losami innego górskiego schroniska, które tuż po II wojnie światowej spłonęło w niewyjaśnionych okolicznościach. Gdy na jaw wychodzą kolejne fakty, Rajczakowski nabiera podejrzeń, że śmierć wuja nie była nieszczęśliwym zrządzeniem losu. Nieświadomy czyhającego zagrożenia podejmuje własne śledztwo. Wkrótce zaczyna otrzymywać pogróżki od kogoś, kto podaje się za Ducha Gór… Jeśli w porę nie rozwikła zagadki, znajdzie się w śmiertelnym niebezpieczeństwie.</p>
<p>Schronisko, które przestało istnieć otwiera serię powieści poświęconych Karkonoszom. To trzymające w napięciu i naznaczone rodzinnymi sekretami kryminały, a także gęsta od zagadek i legend wędrówka po zapomnianych szlakach przeszłości.</p>',
         'Horror', '/images/20.jpeg',363
    ),
    (
         21, 'Schronisko, które przetrwało', 'Sławek Gortych',
         '<p>Nazista uciekający przed sprawiedliwością.</p>
<p>Kobieta próbująca przywrócić honor swojej rodzinie.</p>
<p>Tajemniczy włamywacze szukający śladów przeszłości.</p>
<p>Co ich łączy? Schronisko.</p>
<p>Karkonoskie schronisko Odrodzenie zostaje czasowo zamknięte z powodu remontu. Zarządzająca obiektem Justyna Skała, przyjaciółka Marty i Maksa, korzystając z wolnej chwili, daje się zaprosić tajemniczemu adoratorowi do teatru w rodzinnej Jeleniej Górze. Gdy mężczyzna nie pojawia się w umówionym miejscu, tknięta niejasnymi przeczuciami wraca nocą do schroniska. Okazuje się, że dozorca Odrodzenia zniknął, a w piwnicach budynku grasują włamywacze.</p>
<p>Wkrótce daje o sobie znać nazistowska przeszłość Odrodzenia i rodzą się kolejne pytania. Czy włamanie ma coś wspólnego z morderstwem, do którego doszło w budynku w czasie wojny? Co łączy schronisko z zamachem niemieckich partyzantów na polski pociąg? Czy odkrycia Maksymiliana mają jakiś związek z wydarzeniami, które niepokoją Justynę?</p>
<p>Jedno jest pewne: sekrety Odrodzenia powinny ujrzeć światło dzienne. Są jednak ludzie zdecydowani narazić niejedno życie, by do tego nie doszło…</p>',
         'Kryminał', '/images/21.jpeg', 448
    );
INSERT INTO reviews (
  id, book_id, review, user_login, date,
